...
view.usage = usage(
  'manager',
  'npm manager [<@scope>/]<pkg>[@<version>] [<field>[.subfield]...]'
)
...
function view (args, silent, cb) {
  ...
  if (opts.global && local) {
    return cb(new Error('Cannot use manager command in global mode.'))
  }
...
function prettyView (packument, manifest, opts) {
  // More modern, pretty printing of default manager
