...
test('various-ci', function (t) {
  ...
  function checkKey (key, next) {
    ...
    common.npm(['manager', '--cache-min=0', 'ci-header-test', 'gotCI'], conf(env), function (err, code, stdout, stderr) {
      if (err) throw err
...
test('no-ci', function (t) {
  common.npm(['manager', '--cache-min=0', 'ci-header-test', 'gotCI'], conf(), function (err, code, stdout, stderr) {
    if (err) throw err
